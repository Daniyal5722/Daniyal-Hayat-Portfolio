...
export function FeaturedProject() {
  ...
  return (
    <section className="py-16 bg-[#090a0f] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="text-center mb-10">
          <span className="text-violet-400 font-mono text-xs uppercase tracking-widest block mb-2">FEATURED ARCHITECTURE</span>
        ...
        <motion.div
          ...
          className="relative rounded-3xl bg-gradient-to-br from-slate-900/90 via-slate-900/60 to-slate-950 border border-slate-800 p-8 sm:p-12 shadow-2xl backdrop-blur-xl overflow-hidden group"
        >
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                {featured.features.map((feat, idx) => (
                  <div key={idx} className="flex items-center gap-2 text-sm text-slate-300">
                    <div className="w-5 h-5 rounded-full bg-violet-500/20 flex items-center justify-center text-violet-400 shrink-0">
            ...
            <div className="lg:col-span-5 bg-slate-950/80 border border-slate-800 rounded-2xl p-6 font-mono text-xs text-slate-300 shadow-inner space-y-3">
