        ...
        <div className="grid md:grid-cols-2 gap-8">
          {EDUCATION_DATA.map((item, index) => (
            <motion.div
              ...
              className="p-8 rounded-2xl bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 hover:border-cyan-500/40 dark:hover:border-cyan-500/40 transition-all duration-300 shadow-sm"
            >
              ...
              <p className="text-xs font-mono text-cyan-600 dark:text-cyan-400 mb-4">
                {item.institution}
              </p>
